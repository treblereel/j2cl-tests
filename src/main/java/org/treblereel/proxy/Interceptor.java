...
public class Interceptor {
    ...
    public Interceptor addSetPropertyInterceptor(String obfuscatedPropertyName, BiFunction<Object, String, Boolean> function) {
        set.addProperty(obfuscatedPropertyName, function);
        return this;
    }
