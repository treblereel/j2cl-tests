...
package org.treblereel.databinder.converter;
...
public class Convert {
  ...
  private static Class<?> maybeBoxPrimitive(final Class<?> type) {
    if (type.isPrimitive()) {
      ...
      return boxedTypesByPrimitive.get(type);
    }
    else {
      return type;
    }
  ...
  @SuppressWarnings("rawtypes")
  public static Class inferWidgetValueType(final HTMLElement widget, final Class<?> defaultWidgetValueType) {
